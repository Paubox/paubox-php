...
class MessageContent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets text_plain
     *
     * @param string|null $text_plain Plain text message body. Required if text/html is not provided.
     *
     * @return self
     */
     ...
     * Sets text_html
     *
     * @param string|null $text_html HTML message body. May be HTML-escaped, base64-encoded, or a valid unescaped string. CSS in <style> tags will be rendered inline.
     *
     * @return self
     */
